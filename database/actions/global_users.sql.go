...
SELECT
	id, email, name, about, date_of_birth, created_at, updated_at, profile_picture_id, uncompressed_profile_picture, profile_picture_size, status, thumbnail, small, medium, large, extra_large
FROM
	global.user_details
WHERE
